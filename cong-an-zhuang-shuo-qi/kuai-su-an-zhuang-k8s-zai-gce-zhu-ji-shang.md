...
下載位置：[https://github.com/kubernetes/kubernetes/releases](https://github.com/kubernetes/kubernetes/releases)
...
* 本篇文章參考自：[http://kubernetes.io/docs/getting-started-guides/gce/](http://kubernetes.io/docs/getting-started-guides/gce/)
